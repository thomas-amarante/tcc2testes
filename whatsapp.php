...
// necessário pegar: nome do cliente, telefone, quadra e quadra_local
$id_do_agendamento = $_POST['id']; // id do evento cadastrado na tabela tb_agenda

$sql = "SELECT c.nome, d.nome_quadra_local, b.fone, a.nome_cliente, a.data_inicio FROM tb_agenda a inner JOIN tb_usuario b ON a.id_user = b.id INNER JOIN tb_quadras c ON a.id_quadra = c.id INNER JOIN tb_quadras_locais d ON a.id_quadra_local = d.id WHERE a.id ='$id_do_agendamento'";
$query 	= mysqli_query($conn, $sql);	
$dados = mysqli_fetch_array($query);


$formatar_hora = $dados['data_inicio'];
        ...
        <form accept-charset="utf-8">
            <div class="form-group mb-2">
                ...
                <div class="input-group">
                    ...
                    <input id="phone" type="phone" value="<?php echo $dados['fone']?>" class="form-control rounded-0">
                </div>
            ...
            <div class="form-group mb-2">
                ...
                <div class="input-group">
                    ...
                    <input id="message" type="text" value="Olá <?php echo $dados['nome_cliente']?>, você tem marcado um jogo hoje! Local: <?php echo $dados['nome'] ?>, <?php echo $dados['nome_quadra_local'] ?> às <?php echo $hora ?> " class="form-control rounded-0">
                </div>
