<?php
class PagSeguro{
	private $email         = "thomasferreiraa@gmail.com";
	private $token_sandbox = "8FDC81B6A9544EAB99B706D2411CE2E4";
	private $token_oficial = "TOKEN DO PAGSEGURO";
	private $url_retorno   = "/localhost/includes/notificacao.php";
	...
	public function __construct(){
		$this->email_token = "?email=".$this->email."&token=".$this->token_sandbox; // alterar para token oficial quando sair de ambiente de teste
